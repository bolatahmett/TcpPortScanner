...
{
    internal static class GenerateIpAddress
    {
        private const int MAX_PORT = 65535;
        internal static List<IPAddress> GetFromRange(string fromIP, string toIp)
        {
        ...
        internal static List<Tuple<T, int>> AddPort<T>(this List<T> source)
        {
